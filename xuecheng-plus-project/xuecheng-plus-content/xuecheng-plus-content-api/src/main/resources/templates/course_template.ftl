...
<head>
    ...
    <title>学成在线-${model.courseBaseInfo.name}</title>
...
<div id="learningArea">
    <div class="article-banner">
        ...
        <div class="banner-info">
            <div class="banner-left">
                <p>${model.courseBaseInfo.mtName}<span>\ ${model.courseBaseInfo.stName}</span></p>
                <p class="tit">${model.courseBaseInfo.name}</p>
                <p class="pic">
                    <#if model.courseBaseInfo.charge=='201000'>
                        <span class="new-pic">免费</span>
                    <#else>
                        <span class="new-pic">特惠价格￥${model.courseBaseInfo.price!''}</span>
                        <span class="old-pic">原价￥${model.courseBaseInfo.originalPrice!''}</span>
                    </#if>
                </p>
                <p class="info">
                    <a href="#" @click.prevent="startLearning()">马上学习</a>
                    <span><em>难度等级</em>
                <#if model.courseBaseInfo.grade=='204001'>
                    初级
                <#elseif model.courseBaseInfo.grade=='204002'>
                    中级
                <#elseif model.courseBaseInfo.grade=='204003'>
                    高级
                </#if>
                </span>
                    ...
                    <span><em>授课模式</em>
                 <#if model.courseBaseInfo.teachmode=='200002'>
                     录播
                 <#elseif model.courseBaseInfo.teachmode=='200003'>
                     直播
                 </#if>
                </span>
                </p>
            ...
            <div class="banner-rit">
                <p>
                    <a href="http://www.51xuecheng.cn/course/preview/learning.html?id=${model.courseBaseInfo.id}" target="_blank">
                        <#if model.courseBaseInfo.pic??>
                            <img src="http://file.51xuecheng.cn${model.courseBaseInfo.pic}" alt="" width="270" height="156">
                        <#else>
                        ...
                        <div class="content">
                            ...
                            <div class="content-com suit">
                                ...
                                <div class="cont cktop">
                                    <div >
                                        <p>${model.courseBaseInfo.users!""}</p>
                                    </div>
                            ...
                            <div class="content-com course">
                                ...
                                <div class="cont">
                                    ...
                                    <div class="info-box">
                                        <p class="name">教学方：<em>${model.courseTeacher[0].teacherName}</em></p>
                                        <!-- <p class="lab">高级前端开发工程师 10年开发经验</p>-->
                                        <p class="info">${model.courseTeacher[0].introduction!''}</p>
                            ...
                            <div class="content-com about">
                                ...
                                <div class="cont cktop">
                                    <div >
                                        <p>${model.courseBaseInfo.description!""}</p>
                                    </div>
                                    <!--<span class="on-off">更多 <i class="i-chevron-bot"></i></span>-->
                                </div>
                            </div>
                                    ...
                                    <div class="drop-down" style="height: 260px;">
                                        <ul class="list-box">
                                            <#list firstNode.teachPlanTreeNodes as secondNode>
                                                <li><a href="http://www.51xuecheng.cn/course/preview/learning.html?id=${model.courseBaseInfo.id}&chapter=${secondNode.teachplanMedia.teachplanId!''}" target="_blank">${secondNode.pname}</a></li>
                                            </#list>
                                        </ul>
                                    </div>
                                </div>
    ...
    <div class="popup-course">
        ...
        <div class="popup-course-box">
            <div class="title">${model.courseBaseInfo.name} <span class="close-popup-course-box">×</span></div>
            <div class="content">
    ...
    <div class="popup-box">
        ...
        <div class="popup-pay-box">
            <div class="title">${model.courseBaseInfo.name} <span class="close-popup-pay-box">×</span></div>
            <div class="content">
                <img :src="qrcode" width="200" height="200" alt="请点击支付宝支付按钮，并完成扫码支付。"/>

                <div class="info">
                    <p class="info-tit">${model.courseBaseInfo.name}<span>课程有效期:${model.courseBaseInfo.validDays!''}天</span></p>
                    <p class="info-pic">课程价格 : <span>￥${model.courseBaseInfo.originalPrice!''}元</span></p>
                    <p class="info-new-pic">优惠价格 : <span>￥${model.courseBaseInfo.price!''}元</span></p>
                </div>
            </div>
            <div class="fact-pic">实际支付: <span>￥${model.courseBaseInfo.price!''}元</span></div>
...
<script>var courseId = "${model.courseBaseInfo.id}";var courseCharge = "${model.courseBaseInfo.charge}"</script>
